...
urlpatterns = [
    ...
    path('atualiza_deleta/deleta_clientes/<int:clientes_id>/', views.deleta_clientes, name='deleta_clientes'),
    path('atualiza_deleta/deleta_pedidos/<int:pedidos_id>/', views.deleta_pedidos, name='deleta_pedidos'),
    path('atualiza_deleta/deleta_produtos/<int:produtos_id>/', views.deleta_produtos, name='deleta_produtos'),
]
